...
public class Medicament {
    ...
    private int qte_med = 0;

    public int getNbr_Instante() {
        return nbr_Instante;
    }

    public void setNbr_Instante(int nbr_Instante) {
        this.nbr_Instante = nbr_Instante;
    }

    private int nbr_Instante;
    public Medicament() {

    }
    public int getQte_med() {
        return qte_med;
    }

    public void setQte_med(int qte_med) {
