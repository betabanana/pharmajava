                    ...
                    <div class="app-sidebar__inner">
                          ...
                          <%--  <li class="app-sidebar__heading">
                                <a href="#">
                                    ...
                                    <form action="" method="post">
                             <input type="hidden" name="date" value="test" size=40px>
                             <button > <i class="fa-solid fa-bell" style="font-size: 15px"></i>   <span>Alert</span></button>
                            </form>
                                </a>
                            </li>--%>
                        </ul>
            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <div class="container">  
                     ...
                     <%@ include file="medicament.jsp" %>
                
                     <c:if test="${commande==10000000}">
